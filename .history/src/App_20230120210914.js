      ...
      <main>
        <Routes>
         ...
         <Route path ="/" element={<HomeScreen />}></Route>
          ...
          <Route path ="/product/:slugd" element={<HomeScreen />}></Route>
          ...
          <Route path ="/chat/:id/:sellerId/:orderId/:productId/:productName/:productImage/:productPrice/:productCountInStock/:productQuantity/:productSeller/:productCategory/:productDescription/:productRating" element={<HomeScreen />}></Route>\
          <Route path="/" element={<HomeScreen />}></Route>
